...
Build `components/Field.tsx` per the Form terms in `CONTEXT.md` plus the resolutions of [Select presentation policies](01-select-presentation-policies.md), [Validator on boolean and the definition of empty](02-validator-boolean-and-empty.md), [Accessibility and DOM contract](03-accessibility-dom-contract.md), and [Demo page and test scope](04-demo-page-and-test-scope.md).
